...
export function SelectValue({ placeholder }) {
  ...
  return <span className="font-inter text-sm">{value || placeholder}</span> // Added font-inter text-sm
}

export function SelectContent({ children, align = "start" }) {
